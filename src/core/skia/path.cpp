 ...
 * implementation
 */
static g2_path_t* g2_skia_path_init()
{
	// alloc
...
static tb_void_t g2_skia_path_exit(g2_path_t* path)
{
...
static tb_void_t g2_skia_path_clear(g2_path_t* path)
{
	SkPath* spath = static_cast<SkPath*>(path);
	tb_assert_and_check_return(spath);
...
static tb_void_t g2_skia_path_close(g2_path_t* path)
{
	SkPath* spath = static_cast<SkPath*>(path);
	tb_assert_and_check_return(spath);
...
static tb_bool_t g2_skia_path_null(g2_path_t const* path)
{	
...
static tb_void_t g2_skia_path_move_to(g2_path_t* path, g2_point_t const* pt)
{
	SkPath* spath = static_cast<SkPath*>(path);
...
static tb_void_t g2_skia_path_line_to(g2_path_t* path, g2_point_t const* pt)
{
	SkPath* spath = static_cast<SkPath*>(path);
	tb_assert_and_check_return(spath && pt);
...
static tb_void_t g2_skia_path_quad_to(g2_path_t* path, g2_point_t const* pt, g2_point_t const* cp)
{
	SkPath* spath = static_cast<SkPath*>(path);
...
static tb_void_t g2_skia_path_cube_to(g2_path_t* path, g2_point_t const* pt, g2_point_t const* c0, g2_point_t const* c1)
{
	SkPath* spath = static_cast<SkPath*>(path);
