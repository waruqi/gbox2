...
static g2_pixel_t g2_pixmap_rgb24_pixel_get_b(tb_cpointer_t data)
{
	return g2_bits_get_u24_be(data);
}
static tb_void_t g2_pixmap_rgb24_pixel_set_lo(tb_pointer_t data, g2_pixel_t pixel, tb_byte_t alpha)
{
	g2_bits_set_u24_le(data, pixel);
}
static tb_void_t g2_pixmap_rgb24_pixel_set_bo(tb_pointer_t data, g2_pixel_t pixel, tb_byte_t alpha)
{
	g2_bits_set_u24_be(data, pixel);
}
static tb_void_t g2_pixmap_rgb24_pixel_cpy_o(tb_pointer_t data, tb_cpointer_t pixel, tb_byte_t alpha)
{
...
static tb_void_t g2_pixmap_rgb24_pixels_set_bo(tb_pointer_t data, g2_pixel_t pixel, tb_size_t count, tb_byte_t alpha)
{
	// FIXME
	tb_memset_u24(data, pixel, count);
}
